...
'''
    ...
    stage('Package Code') {
      parallel {
        ...
        stage('Slack') {
          steps {
            slackSend(username: 'yoguez@gmail.com', channel: 'yg-channel-private', color: '#E8E8E8', attachments: '$attachments', blocks: '$blocks', notifyCommitters: true, replyBroadcast: true, sendAsText: true, failOnError: true)
          }
        }
